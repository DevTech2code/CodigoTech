...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 201, description: 'Rol creado correctamente' }),
...
__decorate([
    (0, common_1.Get)(':id'),
    (0, swagger_1.ApiOperation)({ summary: 'Obtener un rol por su ID' }),
    (0, swagger_1.ApiParam)({ name: 'id', type: Number, description: 'ID del rol' }),
...
__decorate([
    (0, common_1.Put)(':id'),
    (0, swagger_1.ApiOperation)({ summary: 'Actualizar un rol existente' }),
    (0, swagger_1.ApiParam)({ name: 'id', type: Number, description: 'ID del rol' }),
