...
let StorageService = class StorageService {
    ...
    async create(dto) {
        try {
            ...
            (0, prisma_error_util_1.handlePrismaError)(error, 'Capacidad de almacenamiento');
        }
    }
    async findAll() {
    ...
    async findOne(id) {
        ...
        if (!storage) {
            throw new common_1.NotFoundException(`Capacidad de almacenamiento con ID ${id} no encontrada`);
        }
        return storage;
    }
    async update(id, dto) {
        try {
            ...
            (0, prisma_error_util_1.handlePrismaError)(error, 'Capacidad de almacenamiento', id);
        }
    }
    async remove(id) {
        try {
